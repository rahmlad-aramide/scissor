  ...
  return (
    <div className="bg-white rounded-lg p-4 mx-auto my-4 w-[90%] flex flex-col md:flex-row justify-between">
      ...
      <div className="mt-4 md:mt-0 flex justify-evenly">
        <div onClick={()=>handleCopy(`https://api.qrserver.com/v1/create-qr-code/?data=cutly.onrender.com/${customUrl}&amp;size=100x100`)} className="flex px-2 py-1 cursor-pointer rounded-lg hover:scale-90 active:scale-100 transition duration-300 border-2 border-gray-300 bg-gray-100 h-fit">
