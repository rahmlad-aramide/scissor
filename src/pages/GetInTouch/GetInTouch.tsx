          ...
          >
            <div>
              ...
              <div>
                ...
                <div className="mt-2 mb-3">
                  <input
                    ...
                    type="text"
                    className="rounded-xl h-[46px] w-full px-4"
                    value={defaultFormFields.company}
                    onChange={handleChange}
                    required
                  />
                </div>
              ...
              <div>
                ...
                <div className="mt-2 mb-3">
                  <input
                    ...
                    type="text"
                    className="rounded-xl h-[46px] w-full px-4"
                    value={defaultFormFields.useCase}
                    onChange={handleChange}
                    required
                  />
                </div>
              ...
              <div>
                ...
                <div className="mt-2 mb-3">
                  <input
                    ...
                    type="text"
                    className="rounded-xl h-[46px] w-full px-4"
                    value={defaultFormFields.country}
                    onChange={handleChange}
                    required
                  />
                </div>
              ...
              <div className="text-neutral-500 text-xs flex items-center justify-start">
                ...
                reach out to you regarding ourproducts and services. You have the option to unsubscribe from these communications whenever you wish. To learn more about how to unsubscribe, our privacy practices, and our dedication to safeguarding your privacy, please refer to our Privacy Policy.
              </div>
              <div className="mt-6">
