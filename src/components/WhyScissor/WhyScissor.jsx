...
const WhyScissor = () => {
  return (
    <section>
      <div className="flex pt-[136px] pb-[130px] justify-between w-[90%] mx-auto text-dark">
        <div className="flex w-[40%]">
          <div className="mr-4 -ml-5">
            <img src={line} alt="vertical line" className="mt-2" />
          </div>
          <div>
            <div className="text-[40px] font-bold">
              Why choose <span className="text-primary">Scissors</span>
            </div>
            <div className="max-w-[37ch] ml-2.5 font-medium">
        ...
        <div className="flex w-[60%]">
          <div className="grid gap-x-7 gap-y-16 grid-cols-1 md:grid-cols-2 mt-2">
