...
const Hero = () => {
  return (
    <section id="url" className="bg-hero-texture bg-cover bg-bottom pt-16">
      <div className="flex text-3xl md:text-5xl font-bold leading-[70px] md:leading-[96px] max-w-[31ch] mx-auto mt-16">
        Optimize Your Online Experience with Our
      </div>
      <div className="text-3xl md:text-5xl font-bold leading-[70px] md:leading-[96px] max-w-[26ch] mx-auto">
        Advanced
      ...
      <div className="flex mt-4">
        <div className="text-lg font-medium text-center max-w-[63ch] mx-auto">
      ...
      <div className="flex mb-16 mt-10">
        <div className="relative mx-auto w-fit backdrop-blur-[106px] rounded-3xl">
          ...
          <div className="bg-[#fefefe]/40 backdrop-blur-lg-[106px] rounded-3xl">
            <div className="bg-[#fefefe]/10 backdrop-blur-[106px] rounded-3xl border-[0.5px] border-primary">
      ...
      <div className="h-24 w-full bg-hero-pattern bg-bottom bg-cover"></div>
    </section>
  );
};
export default Hero;
